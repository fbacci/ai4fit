...
function drawObjectiveImages(currentActivityObjective, svgArray, svgInstance, graphIndex, xScale, yScale, currentChartPosition, overallMaxYValue, svgContainerWidth, currentActivityMaxTime, currentActivityMaxYValue, yScaleChecked) {
    ...
    if (currentActivityObjective == "TIME") {
        svgArray[svgInstance].append("svg:image")
            ...
            .attr('xlink:href', '/static/ai4fitapp/img/time.png')
            .attr('x', xPosition-3)
            .attr('y', yPosition)
            .attr('width', 30)
            .attr('height', 30);
        ...
        svgArray[svgInstance].append("svg:image")
            ...
            .attr('id', 'activity-type-img' + graphIndex)
            .attr('xlink:href', '/static/ai4fitapp/img/distance.png')
            .attr('x', xPosition)
            .attr('y', yPosition)
            .attr('width', 30)
            .attr('height', 30);
        ...
        svgArray[svgInstance].append("svg:image")
            ...
            .attr('id', 'activity-type-img' + graphIndex)
            .attr('xlink:href', '/static/ai4fitapp/img/distancetime.png')
            .attr('x', xPosition)
            .attr('y', yPosition)
            .attr('width', 70)
            .attr('height', 30);
        ...
        svgArray[svgInstance].append("svg:image")
            ...
            .attr('id', 'activity-type-img' + graphIndex)
            .attr('xlink:href', '/static/ai4fitapp/img/pace.png')
            .attr('x', xPosition-5)
