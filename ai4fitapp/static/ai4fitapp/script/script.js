...
d3.dsv(',', '/static/ai4fitapp/datasets/workout.csv').then(function (data) {
// SVG
...
function fillUserList(users, mark, accuracy) {
    ...
    users.forEach(function (element) {
        ...
        profilePic.src = "/static/ai4fitapp/img/profile-pic"+(img_number%5)+".png";
        ...
        arrow.src = "/static/ai4fitapp/img/arrow.png";
